...
module.exports = function(options) {
    ...
    var plugins = [
        ...
        },
        {
            ...
            settings: "defaults",
            template: "<settings><user /><project /><state><console expanded=\"false\">{\"type\":\"pane\",\"nodes\":[]}</console></state></settings>",
        ...
        // read only
        "plugins/c9.vfs.client/vfs.listener",
        // {
